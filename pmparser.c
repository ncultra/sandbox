...
void
pmparser_free (procmaps_struct * maps_list)
{
  if (maps_list == NULL)
    return;
...
void
_pmparser_split_line (char *buf, char *addr1, char *addr2,
...
void
pmparser_print (procmaps_struct * map, int order)
{
