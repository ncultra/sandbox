...
static int read_refxen_data(int fd, const char *filename, struct patch *patch)
{
...
static int read_blob_data(int fd, const char *filename, struct patch *patch)
{
    /* Pull the blob out */
...
static int read_reloc_data(int fd, const char *filename, struct patch *patch)
{
...
static int read_check_data(int fd, const char *filename, struct patch *patch)
{
    size_t i;
...
static int read_func_data(int fd, const char *filename, struct patch *patch)
{
    size_t i;
...
static int read_table_data(int fd, const char *filename, struct patch *patch)
{
    size_t i;
...
static int read_tag_data(int fd, const char *filename, struct patch3 *patch)
{
    uint16_t size;
    if (_readu16(fd, filename, &size) < 0)
        return -1;
...
static int read_deps_data(int fd, const char *filename, struct patch3 *patch)
{
    size_t i;
...
static int read_reloc_data3(int fd, const char *filename, struct patch3 *patch)
{
    size_t i;
...
static int read_symbols_data(int fd, const char *filename, struct patch3 *patch)
{
    size_t i;
...
static int _load_patch_file3(int fd, const char *filename, struct patch3 *patch)
{
